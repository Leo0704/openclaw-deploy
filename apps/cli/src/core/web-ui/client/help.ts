  ...
  return `    // ============================================
    ...
    async function loadHelp() {
      ...
      el.innerHTML = \`
        ...
        <div class="help-section">
          <h3 style="font-size:16px;color:#1F2937;margin-bottom:16px">🔄 龙虾助手更新说明</h3>
          <div class="help-item">
            <div class="help-title">更新检查频率</div>
            <div class="help-content">
              龙虾助手会在启动后自动检查更新，每 24 小时检查一次。你也可以随时点击"检查更新"按钮手动检查。
            </div>
          </div>
          <div class="help-item">
            <div class="help-title">更新类型说明</div>
            <div class="help-content">
              <ul>
                <li><strong>已是最新版本</strong>：当前已是最新版本，无需操作。</li>
                <li><strong>有可用更新</strong>：有新版本来，但不会强制更新，你可以自行决定是否更新。</li>
                <li><strong>建议更新</strong>：有大版本更新，建议更新以获得最新功能。</li>
                <li><strong>必须更新</strong>：当前版本低于最低支持版本，部署 OpenClaw 等操作会被阻止，需要先更新龙虾助手。</li>
              </ul>
            </div>
          </div>
          <div class="help-item">
            <div class="help-title">普通版本不会阻止部署</div>
            <div class="help-content">
              即使发现新版本，只要不是"必须更新"模式，你仍然可以正常部署和使用 OpenClaw，不会被强制更新阻断。
            </div>
          </div>
          <div class="help-item">
            <div class="help-title">macOS 更新方式</div>
            <div class="help-content">
              由于 macOS 的安全限制，macOS 版本需要手动下载更新包进行更新。点击"立即更新"后会打开下载页面，你需要下载最新版本后手动替换应用。
            </div>
          </div>
        </div>
